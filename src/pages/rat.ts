      ...
      <div class="container">
        <div class="module-next__inner">
          <div>
            ...
            <h3 class="t-h3">Each puzzle is an item.</h3>
            <p>Every puzzle you see in this module is recorded as an item in your spaced-recall bank. Puzzles come back in <a href="/drill">/drill</a> when their half-life elapses. A correct recall multiplies the half-life by 1.7; a missed recall halves it. Take this module a few times and your bank fills up.</p>
          </div>
